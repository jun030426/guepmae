...
const REPORT_SCHEMA = z.object({
  ...
  disclaimer: z
    .string()
    .describe(
      '카드 하단 면책 한 줄. "이 분석은 [데이터 기준] 과거 데이터 패턴 설명입니다. 미래 가격 예측이나 투자 권유가 아닙니다." 형태.',
    ),
});
...
출력 형식은 주어진 JSON schema 를 정확히 따르세요. disclaimer 필드에 "미래 가격 예측이나 투자 권유가 아닙니다" 명시는 필수입니다.`;
...
- disclaimer 필드에 "미래 가격 예측이나 투자 권유가 아닙니다" 명시.
